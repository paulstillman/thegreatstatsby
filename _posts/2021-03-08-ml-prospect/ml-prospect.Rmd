...
For the R portions, I'll try to explain everything I use, but it will be helpful to be familiar with the [pipe](https://r4ds.had.co.nz/pipes.html) (`%>%`) and the baiscs of  [dplyr](https://dplyr.tidyverse.org/). We'll also juse [purrr](https://r4ds.had.co.nz/iteration.html#the-map-functions), and [nested data/broom](https://cran.r-project.org/web/packages/broom/vignettes/broom_and_dplyr.html), but I'll go more in depth on both of those.
